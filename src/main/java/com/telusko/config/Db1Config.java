...
transactionManagerRef="db1TransactionManager", basePackages="com.telusko.repo.customer")
public class Db1Config 
{
	//DataSource
	@Bean
	@Primary
	@ConfigurationProperties(prefix="db1.datasource")	//read the data from .properties file
	...
	public LocalContainerEntityManagerFactoryBean db1EntityManagerFactory(EntityManagerFactoryBuilder emfb) {
		...
		return emfb.dataSource(db1DataSoource()).
